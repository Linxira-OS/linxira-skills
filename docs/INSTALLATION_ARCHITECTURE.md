...
The target first npm release ships the 16 metadata-audited first-party skills,
...
ignored `payload/` directory from 16 audited first-party skills plus the seven
