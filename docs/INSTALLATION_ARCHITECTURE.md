...
The target first npm release ships the 15 metadata-audited first-party skills,
...
ignored `payload/` directory from 15 audited first-party skills plus the seven
